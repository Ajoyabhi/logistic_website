...
import { stats, serviceStates, promises } from "@/lib/site";

export const metadata: Metadata = {
  title: "About Us",
  description: "DPSV Logistic is a Gorakhpur-based moving, packing and on-demand transport company with its own trained crew — helping families and businesses shift across North & Central India, stress-free.",
};
  ...
  return (
    <>
      ...
      <section className="py-16 md:py-24">
        <div className="shell grid items-center gap-12 lg:grid-cols-2">
          <div className="relative aspect-[4/3] overflow-hidden rounded-xl shadow-xl">
            <Image src="https://images.unsplash.com/photo-1594732832278-abd644401426?auto=format&fit=crop&w=1400&q=75" alt="DPSV moving crew" fill className="object-cover" sizes="(max-width:1024px) 100vw, 50vw" />
          </div>
          <div>
            <SectionTitle eyebrow="Who we are" title="Moving India, the honest way" intro="DPSV Logistic is a new-age moving and transport company built on a simple idea: do it yourself, and do it right. We handle home shifting, office relocation, intercity moves, car & bike transport and on-demand mini-trucks — all with our own trained crew and our own vehicles." />
            <p className="mt-4 text-mute">Moving is stressful and the industry is full of middlemen, hidden charges and broken promises. We started DPSV to fix that — with transparent pricing, careful packing, and a team that treats your belongings like their own, from the first survey to the last box unpacked.</p>
      ...
      <section id="why" className="bg-cloud py-16 md:py-24">
        <div className="shell">
          <SectionTitle center eyebrow="Why choose us" title="What makes a DPSV move different" />
      ...
      <section className="relative overflow-hidden bg-navy-800 py-20 text-white md:py-24">
        ...
        <div className="shell relative">
          <SectionTitle light center eyebrow="Our track record" title="Trusted by thousands across the region" />
          ...
          <div className="mt-14 border-t border-white/15 pt-10 text-center">
            <p className="text-sm uppercase tracking-widest text-white/60">States we operate in</p>
            <div className="mt-5 flex flex-wrap justify-center gap-3">
              {serviceStates.map((s) => (
                <span key={s} className="inline-flex items-center gap-2 rounded-full border border-white/20 px-4 py-2 text-sm font-600 text-white/90">
